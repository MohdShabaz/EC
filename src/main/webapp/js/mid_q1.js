...
console.log(document.getElementById('place_order').innerHTML);
 ...
 price=[];
  $.ajax({
        type :"GET",
       url: "http://localhost:9000/EC/webapi/buyerService/allBuyers",
       async: false,
       headers: {
...
//                                '</span>'+
                          '<span class="col-sm-2" style="margin-left:50px"><p>'+Sno+'</p></span>'+
                                '<span class="col-sm-2" style="margin-left:50px"><p>'+result[x].buyer_id+'</p></span>'+
                                '<span class="col-sm-2" style="margin-left:50px"><p>'+result[x].buyer_name+'</p></span>'+
                                '<span class="col-sm-2" style="margin-left:50px"><p>'+result[x].buyer_balance+'</p></span>'+
//                                '<span class="col-sm-3">'+
