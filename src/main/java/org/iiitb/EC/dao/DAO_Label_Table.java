...
public class DAO_Label_Table {
	public static boolean add_Item_Label(String barcode,String key,String value)
	{
		...
		String query=null;
		query = "insert into label_table(item_id,label,value) VALUES " +
				 "(?,?,?);";
	...
	public static ArrayList<label_table> get_all_label_value(int item_id){
		...
		try {
			...
			while(rs.next()) {
					...
					label_table_object.setValue(rs.getString("value"));
